...
public class GuncraftingBlock extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:guncrafting")
	public static final Block block = null;
	public GuncraftingBlock(NeomodModElements instance) {
		super(instance, 13);
	}
