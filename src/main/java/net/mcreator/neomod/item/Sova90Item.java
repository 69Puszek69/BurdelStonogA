...
public class Sova90Item extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:sova_9_0")
	public static final Item block = null;
	@ObjectHolder("neomod:entitybulletsova_9_0")
	public static final EntityType arrow = null;
	public Sova90Item(NeomodModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletsova_9_0").setRegistryName("entitybulletsova_9_0"));
	}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("neomod:sova90")), SoundCategory.PLAYERS,
