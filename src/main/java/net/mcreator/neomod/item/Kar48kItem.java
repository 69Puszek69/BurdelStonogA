...
public class Kar48kItem extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:kar_4_8k")
	public static final Item block = null;
	@ObjectHolder("neomod:entitybulletkar_4_8k")
	public static final EntityType arrow = null;
	public Kar48kItem(NeomodModElements instance) {
		super(instance, 2);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletkar_4_8k").setRegistryName("entitybulletkar_4_8k"));
	}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 4f, 20, 0);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("neomod:kar48k")), SoundCategory.PLAYERS,
