...
public class ElectricalAmmoItem extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:electrical_ammo")
	public static final Item block = null;
	public ElectricalAmmoItem(NeomodModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("electrical_ammo");
		}
