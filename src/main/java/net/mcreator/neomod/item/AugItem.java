...
public class AugItem extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:aug")
	public static final Item block = null;
	@ObjectHolder("neomod:entitybulletaug")
	public static final EntityType arrow = null;
	public AugItem(NeomodModElements instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletaug").setRegistryName("entitybulletaug"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				ArrowCustomEntity entityarrow = shoot(world, entity, random, 2.4f, 2.2, 0);
