...
public class GlockItem extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:glock")
	public static final Item block = null;
	@ObjectHolder("neomod:entitybulletglock")
	public static final EntityType arrow = null;
	public GlockItem(NeomodModElements instance) {
		super(instance, 21);
	}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("neomod:glock")), SoundCategory.PLAYERS, 1,
