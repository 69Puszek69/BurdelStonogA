...
import net.mcreator.neomod.procedures.RecipeOpenerProcedure;
...
public class RecipeBookItem extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:recipe_book")
	public static final Item block = null;
	public RecipeBookItem(NeomodModElements instance) {
		super(instance, 25);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(GunZItemGroup.tab).maxStackSize(1));
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Recipe Book");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new RecipeBookMainGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			}
			{
				...
				RecipeOpenerProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
