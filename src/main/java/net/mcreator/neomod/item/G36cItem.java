...
public class G36cItem extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:g_3_6c")
	public static final Item block = null;
	@ObjectHolder("neomod:entitybulletg_3_6c")
	public static final EntityType arrow = null;
	public G36cItem(NeomodModElements instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletg_3_6c").setRegistryName("entitybulletg_3_6c"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				ArrowCustomEntity entityarrow = shoot(world, entity, random, 3.4f, 3, 1);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("neomod:g36c")), SoundCategory.PLAYERS, 1,
