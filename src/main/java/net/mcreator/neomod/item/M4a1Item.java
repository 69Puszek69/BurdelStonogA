...
public class M4a1Item extends NeomodModElements.ModElement {

	@ObjectHolder("neomod:m_4a_1")
	public static final Item block = null;

	@ObjectHolder("neomod:entitybulletm_4a_1")
	public static final EntityType arrow = null;

	public M4a1Item(NeomodModElements instance) {
		super(instance, 16);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletm_4a_1").setRegistryName("entitybulletm_4a_1"));
	}
