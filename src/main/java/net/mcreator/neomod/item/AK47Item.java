...
public class AK47Item extends NeomodModElements.ModElement {
	@ObjectHolder("neomod:ak_4_7")
	public static final Item block = null;
	@ObjectHolder("neomod:entitybulletak_4_7")
	public static final EntityType arrow = null;
	public AK47Item(NeomodModElements instance) {
		super(instance, 3);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletak_4_7").setRegistryName("entitybulletak_4_7"));
	}
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Kalashnikova"));
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (entity.abilities.isCreativeMode || EnchantmentHelper.getEnchantmentLevel(Enchantments.INFINITY, itemstack) > 0 || slotID != -1) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 2.6f, 2.3, 0);
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("neomod:ak47")), SoundCategory.PLAYERS, 1,
